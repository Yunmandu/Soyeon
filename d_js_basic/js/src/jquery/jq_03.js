...
/* ES6기반의 코드
  ...
  */
  ...
  // console.log(con);
  myBox.html('<p>요소를 생성하였습니다.</p>'); //기존요소를 삭제하고, 새롭게 추가
  myBox.append('<p>요소를 생성하였습니다.</p>'); //기존요소를 두고, 내부에 뒤에 추가
  myBox.prepend('<p>요소를 추가로 앞에 생성하였습니다.</p>');//기본요소를 두고, 내부에 앞에 추가
 ...
 // 확인(크기,속성)==================================================================
 // width(), height(),
 // innerWidth(), outerWidth(), outerWidth(ture), innerHeight(), outerHeight(), outerHeight(true)
 ...
 // parseInt(),parseFloat();
  ...
  // let resultoutertrueWidth = resultBox.outerWidth(true); //margin 값을 포함한 width
  // console.log(resultoutertrueWidth); 
  ...
  //  resultBox.after('<a href="'+ url +'">클릭하면 이동합니다.</a>');
   resultBox.after(`<a href="${url}">클릭하면 이동합니다2.</a>`);
 ...
 /* $().animate({},function(){
  ...
  // 이벤트
  // show(), hide(), fadeIn , fadeOut, slidUp, slideDown, toggle, hasClass......
